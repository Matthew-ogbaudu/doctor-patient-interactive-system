...
{{--    <script src="{{ asset('js/custom.js')}}"></script>--}}
    ...
    <link href="{{url('assets/css/templatemo-medic-care.css')}}" rel="stylesheet">
    <!--
...
{{--                                <img src="{{url('assets/images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.')}}">--}}
                                <img src="images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg" class="img-fluid" alt="">
                            </div>
