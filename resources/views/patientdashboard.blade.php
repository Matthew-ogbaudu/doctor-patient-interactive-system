                ...
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="nav-profile-text">
                            <p class="mb-1 text-black">{{Auth::guard('patient')->user()->name}}</p>
                        </div>
                    </a>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                <li class="nav-item nav-profile">
                    <a href="#" class="nav-link">
                        ...
                        <div class="nav-profile-text d-flex flex-column">
                            <span class="font-weight-bold mb-2">{{Auth::guard('patient')->user()->name}}</span>
                            <span class="text-secondary text-small">Patient ID : {{Auth::guard('patient')->user()->id}}</span>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('viewappointment')}}">
                        <span class="menu-title">View Appointments</span>

                    </a>
                </li>
                <li class="nav-item">
                    <form action="{{route('patientlogout')}}" method="POST">
                        @csrf
